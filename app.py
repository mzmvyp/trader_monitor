...
class IntegratedController:
    ...
    def setup_routes(self):
        ...
        @self.app.route('/api/trading/scanner')
        def get_market_scanner():
             try:
                 scanner_data = self.trading_analyzer.get_market_scanner()
                 return jsonify(scanner_data)
             except Exception as e:
                 logger.error(f"Erro ao obter market scanner: {e}")
        ...
        def get_integrated_status():
            ...
            trading_health = self.trading_analyzer.get_system_status()
